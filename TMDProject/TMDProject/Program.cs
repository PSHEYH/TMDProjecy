...
namespace TMDProject
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                new Student{ Surname ="Sheychenko" , Name = "Pavel" , Group="PA 18 1"},
                new Student{ Surname ="Solovyov" , Name = "Pavel" , Group="PA 18 1"},
                new Student{ Surname ="RIPna" , Name = "Olena" , Group="PA 18 1"},
                new Student{ Surname ="SCherbak" , Name = "Roman" , Group="PA 18 1"}
