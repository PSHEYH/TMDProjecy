...
namespace TMDProject
{
    public static class Theory
    {
        public static void Lesson1() 
        {
            ...
            Console.WriteLine("   В эт ом классе задач рассматривается такие задачи принятия решений в, которых одна сторона принимает решение" +
            ...
            Console.WriteLine("  Чтобы задать модель необходимо :" +
                ...
                "   V={v_ij}_mxn , де v_ij - это субъективна характеристика которая даёт лицу что принимает решение alpha_i, а" +
            ...
            Console.WriteLine("    b1    b2 \n" +
                              ...
                              " a2 v21   v22\n" +
                              " a3 v31   v32\n");
            Console.WriteLine("   Будем называть эту матрицу матрицу полезности L ");
            Console.WriteLine("   Однако вряд ли у природы можно что то выйграть по этому определим так называемую матрицу потерь Q");

            Console.WriteLine("   Q= {q_ij}_mxn:  q_ij=max(l_ij)-l_ij");
        ...
        public static void Lesson2() 
        {
            ...
            Console.WriteLine("  Отображает психологию Лица что Принимает Решение, которая стоит на позиции наибольшего пессимизма.\n" +
                "  Такое лицо выбирает решение альф1 увереный в том что его проигрыш составит max l1j, тоесть выбирает alpha_i - max l_ij,а\n среди" +
        ...
        public static void Lesson3() 
        {
            ...
            Console.WriteLine("     Случай когда природа находиться только в двух состояниях бета1 и бета2 при єтом один из них считается \n" +
                "   контролированым. Для него вводиться пороговое значение, L_пор. - пороговое значение потерь все те решение которые при \n" +
            ...
            Console.WriteLine("   Пусть бета2 - неконтроллируемое, L_пор. = 0,7");
            Console.WriteLine("   Тогда альфа1 удаляеться из множества решений так как матрица потерь имеет вид ");
            Console.WriteLine("    0   1\n" +
                "    0,1   0,6\n" +
                "    0,9   0,4");
